#' Determine if a Friday is the third Friday of the month
#' 
#' Use this function to determine if a Friday is the third Friday of the month.
#' @export
#' 
#' 
